...
#define AP_DDS_DELAY_SPEED_TIMEOUT_MS 30  // Notbremse nach 30ms ohne Speed-Signal
#endif

#ifndef AP_DDS_EXPECTED_SPEED_TOPIC_HZ
#define AP_DDS_EXPECTED_SPEED_TOPIC_HZ 100
#endif

#ifndef AP_DDS_EXPECTED_SPEED_TOPIC_MS
#define AP_DDS_EXPECTED_SPEED_TOPIC_MS (1000U / AP_DDS_EXPECTED_SPEED_TOPIC_HZ)
#endif
