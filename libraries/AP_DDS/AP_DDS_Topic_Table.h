...
constexpr struct AP_DDS_Client::Topic_table AP_DDS_Client::topics[] =
  {
...
#if AP_DDS_NAVSATFIX_PUB_ENABLED
    {
      ...
      .dw_id =
        uxrObjectId{.id = to_underlying(TopicIndex::NAV_SAT_FIX_PUB), .type = UXR_DATAWRITER_ID},
      .dr_id =
        uxrObjectId{.id = to_underlying(TopicIndex::NAV_SAT_FIX_PUB), .type = UXR_DATAREADER_ID},
      .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_STATIC_TF_PUB_ENABLED
    {
      ...
      .dw_id =
        uxrObjectId{
          .id = to_underlying(TopicIndex::STATIC_TRANSFORMS_PUB), .type = UXR_DATAWRITER_ID},
      .dr_id =
        uxrObjectId{
          .id = to_underlying(TopicIndex::STATIC_TRANSFORMS_PUB), .type = UXR_DATAREADER_ID},
      .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_BATTERY_STATE_PUB_ENABLED
    {
      ...
      .dw_id =
        uxrObjectId{.id = to_underlying(TopicIndex::BATTERY_STATE_PUB), .type = UXR_DATAWRITER_ID},
      .dr_id =
        uxrObjectId{.id = to_underlying(TopicIndex::BATTERY_STATE_PUB), .type = UXR_DATAREADER_ID},
      .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_LOCAL_POSE_PUB_ENABLED
    {
      ...
      .dr_id =
        uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_POSE_PUB), .type = UXR_DATAREADER_ID},
      .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_LOCAL_VEL_PUB_ENABLED
    {
      ...
      .dw_id =
        uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_VELOCITY_PUB), .type = UXR_DATAWRITER_ID},
      .dr_id =
        uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_VELOCITY_PUB), .type = UXR_DATAREADER_ID},
      .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_AIRSPEED_PUB_ENABLED
    {
      ...
      .dw_id =
        uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_AIRSPEED_PUB), .type = UXR_DATAWRITER_ID},
      .dr_id =
        uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_AIRSPEED_PUB), .type = UXR_DATAREADER_ID},
      .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_RC_PUB_ENABLED
    {
      ...
      .dw_id =
        uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_RC_PUB), .type = UXR_DATAWRITER_ID},
      .dr_id =
        uxrObjectId{.id = to_underlying(TopicIndex::LOCAL_RC_PUB), .type = UXR_DATAREADER_ID},
      .topic_rw = Topic_rw::DataWriter,
      .topic_name = "rt/ap/rc",
...
#if AP_DDS_GPS_GLOBAL_ORIGIN_PUB_ENABLED
    {
      ...
      .dw_id =
        uxrObjectId{
          .id = to_underlying(TopicIndex::GPS_GLOBAL_ORIGIN_PUB), .type = UXR_DATAWRITER_ID},
      .dr_id =
        uxrObjectId{
          .id = to_underlying(TopicIndex::GPS_GLOBAL_ORIGIN_PUB), .type = UXR_DATAREADER_ID},
      .topic_rw = Topic_rw::DataWriter,
...
#if AP_DDS_WHEEL_DATA_PUB_ENABLED
    {
      .topic_id = to_underlying(TopicIndex::WHEEL_DATA_PUB),
      .pub_id = to_underlying(TopicIndex::WHEEL_DATA_PUB),
      .sub_id = to_underlying(TopicIndex::WHEEL_DATA_PUB),
      .dw_id =
        uxrObjectId{.id = to_underlying(TopicIndex::WHEEL_DATA_PUB), .type = UXR_DATAWRITER_ID},
      .dr_id =
        uxrObjectId{.id = to_underlying(TopicIndex::WHEEL_DATA_PUB), .type = UXR_DATAREADER_ID},
      .topic_rw = Topic_rw::DataWriter,
      .topic_name = "rt/ap/wheel_data",
      .type_name = "sam_msgs_package::msg::dds_::WheelData_",
      .qos =
        {
          .durability = UXR_DURABILITY_VOLATILE,
          .reliability = UXR_RELIABILITY_BEST_EFFORT,
...
#if AP_DDS_DYNAMIC_TF_SUB_ENABLED
    {
      ...
      .dw_id =
        uxrObjectId{
          .id = to_underlying(TopicIndex::DYNAMIC_TRANSFORMS_SUB), .type = UXR_DATAWRITER_ID},
      .dr_id =
        uxrObjectId{
          .id = to_underlying(TopicIndex::DYNAMIC_TRANSFORMS_SUB), .type = UXR_DATAREADER_ID},
      .topic_rw = Topic_rw::DataReader,
      .topic_name = "rt/ap/tf",
      .type_name = "tf2_msgs::msg::dds_::TFMessage_",
      .qos =
...
#if AP_DDS_VEL_CTRL_ENABLED
    {
      ...
      .dw_id =
        uxrObjectId{
          .id = to_underlying(TopicIndex::VELOCITY_CONTROL_SUB), .type = UXR_DATAWRITER_ID},
      .dr_id =
        uxrObjectId{
          .id = to_underlying(TopicIndex::VELOCITY_CONTROL_SUB), .type = UXR_DATAREADER_ID},
      .topic_rw = Topic_rw::DataReader,
...
#if AP_DDS_GLOBAL_POS_CTRL_ENABLED
    {
      ...
      .dw_id =
        uxrObjectId{
          .id = to_underlying(TopicIndex::GLOBAL_POSITION_SUB), .type = UXR_DATAWRITER_ID},
      .dr_id =
        uxrObjectId{
          .id = to_underlying(TopicIndex::GLOBAL_POSITION_SUB), .type = UXR_DATAREADER_ID},
      .topic_rw = Topic_rw::DataReader,
